...
* Download the Octanist GTM template (`template.tpl`) to your computer.
  ...
  ![](/images/google-tag-manager/incoming-gtm-clickondownloadtemplate.jpg)
...
![](/images/google-tag-manager/incoming-gtm-search-for-octanist.png)

* Press the **Add to Workspace**—button

![](/images/google-tag-manager/incoming-gtm-add-octanist-to-workspace.png)
