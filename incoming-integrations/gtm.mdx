...
## 3. Import the Tag Template (Google Tag Manager)
...
* **Upload the Template**
  ...
  * Click on the three dots in the top-right corner, select **Import**, and upload `template.tpl`. You have dou have downloaded this on step 1. Do not change the name of the original name.

![](/images/6bbb08b8-0b1b-4eab-83f1-76f051af9fc0.png)

* **Save the template** - Don't change any settings here.![](/images/850cd330-08af-48a6-a91a-e497b5fc1772.png)

## 4. Set up the Tag (Google Tag Manager)

1. **Configure the Tag**

   * Create a new tag: **Octanist - Offline Conversion Tracking**.&#x20;

     *After succesfully importing the template. The Octanist Tag should appear under the Custom Tab.*
