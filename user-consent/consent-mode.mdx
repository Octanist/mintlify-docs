...
1. **Google Consent Mode (default)**
   ...
   If you have implemented Google Consent Mode using a certified CMP (e.g., Cookiebot or CookieYes) or a Consent Mode Tag Template (e.g., [Simo Ahava’s Consent Mode Template](https://www.simoahava.com/custom-templates/consent-mode/)), the Octanist Tag Template will respect user consent and automatically set "Granted" or "Denied" accordingly.

   ![](images/meta-facebook/meta-outgoing-connection-setup.jpg)

2. **Manual Consent Settings**

   If you do not use Google Consent Mode, you can set custom consent variables. These variables should return "true" or "false" based on whether the user has provided consent.
