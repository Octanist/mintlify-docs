---
title: "Consent Mode"
description: "How Octanist works with Google Consent Mode."
---
...
<Warning>
  **Note:** If no consent settings are provided (via Google Consent Mode or
  manual settings), leads are automatically marked as "Denied" and cannot be
  attributed to Google Ads campaigns or ads.
</Warning>
...
In our [Google Tag Manager template](https://tagmanager.google.com/gallery/#/owners/Octanist/templates/octanist-gtm-template), there is a dedicated tab for Consent. This tab includes two options:

1. **Google Consent Mode (default)**

If you have implemented Google Consent Mode using a certified CMP (e.g., [Cookiebot](https://www.cookiebot.com/) or [CookieYes](https://www.cookieyes.com/welcome/?ref=njuwmjq)) or a Consent Mode Tag Template (e.g., [Simo Ahava’s Consent Mode Template](https://www.simoahava.com/custom-templates/consent-mode/)), the Octanist Tag Template will respect user consent and automatically set "Granted" or "Denied" accordingly.![](/images/consent-octanist-option.jpg)

1. **Manual Consent Settings**

If you do not use Google Consent Mode, you can set custom consent variables. These variables should return "true" or "false" based on whether the user has provided consent.![](/images/consent/consent-mode-manual-consent-settings.png)
...
<Warning>
  **Recommendation:** Verify that all leads being sent were legitimately
  collected with user consent. Use this feature sparingly and prioritize using
  Google Consent Mode or manual consent settings.
</Warning>

![](/images/consent/consent-mode-consented-leads-google-ads.jpg)
