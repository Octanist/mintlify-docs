...
![Recruitee Octanist Add Integration Pn](/images/recruitee-octanist-add-integration.png)
...
<Tip>
  This name is for internal use only and helps you identify the integration within Octanist.
</Tip>
...
![Recruitee Create Recruiteeintegration Pn](/images/recruitee-create-recruiteeintegration.png)
...
1. Go to [Recruitee](https://app.recruitee.com/) and log in.
   ...
   <img
     src="/images/recruitee-click-on-settings.png"
...
<img
  src="/images/recruitee-app-and-plugins.png"
...
![Octanist Recruitee Fill In The Integrations Fields Pn](/images/octanist-recruitee-fill-in-the-integrations-fields.png)

8. **Copy the POST URL** and paste it into Recruitee. You can **now create the Recruitee integration**.

![Recruitee Add Recruitee Incoming Integration Copy Pn](/images/recruitee-add-recruitee-incoming-integration-copy.png)

9. Back in Recruitee, click **New Webhook**.

![Recruitee Click New Webhook Pn](/images/recruitee-click-new-webhook.png)
...
![Recruitee Webhook Fill In The Fields Pn](/images/recruitee-webhook-fill-in-the-fields.png)
