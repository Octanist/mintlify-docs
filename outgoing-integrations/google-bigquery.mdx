...
![Create BigQuery Project](/images/google-bigquery/google-bigquery-outgoing-integration-create-bigquery-project.jpg)
...
![Enable BigQuery API](/images/google-bigquery/google-bigquery-outgoing-integration-enable-bigquery-api.jpg)

### 1.2 Enabling APIs and Permissions

Now, search for **IAM & Admin**, and click **Grant Access**.

![Grant Access](/images/google-bigquery/google-bigquery-outgoing-integration-grant-access.jpg)
...
![Add Roles](/images/google-bigquery/google-bigquery-outgoing-integration-add-roles.jpg)

Return to the search bar, search for **BigQuery**, and click it to open the BigQuery Studio.

![Open BigQuery Studio](/images/google-bigquery/google-bigquery-outgoing-integration-bigquery-searchbar.jpg)
...
![Create Dataset](/images/google-bigquery/google-bigquery-outgoing-integration-create-dataset.jpg)
...
![Dataset ID and Region](/images/google-bigquery/google-bigquery-outgoing-integration-create-dataset-id-and-region.jpg)

Once the dataset is created:

1. Click the three dots next to the dataset name and choose **Create table**.

![Create Table](/images/google-bigquery/google-bigquery-outgoing-integration-create-table.jpg)
...
![Table Settings](/images/google-bigquery/google-bigquery-create-table.png)
...
![Disable Table Expiry](/images/google-bigquery/google-bigquery-outgoing-integration-edit-table-expiry.jpg)
...
![Octanist Setup](/images/google-bigquery/bigquery-octanist-outgoing-integration-setup-octanist.png)
