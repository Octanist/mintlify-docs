...
6. Save the conversion action and click **Next**.

7. On the next screen, you will be prompted to set up your new data source. Do not proceed with this step yet. Click **Done** instead.
