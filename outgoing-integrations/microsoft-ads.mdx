...
<Note>
  **Note:** This is an advanced integration. Familiarity with Microsoft Ads conversion tracking and lead attribution is required.
</Note>
...
![Outgoing Integrations Microsoft Ads Add Integration Pn](/images/outgoing-integrations-microsoft-ads-add-integration.png)
...
<Warning>
  The conversion goal name in Microsoft Ads must exactly match the one defined in Octanist.
</Warning>
...
<Note>
  We recommend not including the goal in conversions initially. Activate this once you’ve collected at least 30 converted leads for better optimization.
</Note>

5. Under **Enhanced Conversions**, select **Disable** (you can enable this later if desired).

![Outgoing Integrations Microsoft Ads Create Conversion Pn](/images/outgoing-integrations-microsoft-ads-create-conversion.png)
...
![Outgoing Integrations Microsoft Ads Add Schedule Pn](/images/outgoing-integrations-microsoft-ads-add-schedule.png)
...
<Note>
  Scheduling uploads ensures that Octanist leads are regularly synced with Microsoft Ads without manual intervention.
</Note>

![Outgoing Integrations Microsoft Ads Add File Url Pn](/images/outgoing-integrations-microsoft-ads-add-file-url.png)
